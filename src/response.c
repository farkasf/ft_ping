...
/*   Updated: 2024/09/16 23:52:09 by ffarkas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_ping_response(t_ping *ping, t_reply *reply)
{
	...
	{
		dprintf(STDOUT_FILENO, "%d bytes from %s (%d): %s\n", bytes, ping->network.host_ip, ping->network.host_ip, fetch_icmp_error(reply));
